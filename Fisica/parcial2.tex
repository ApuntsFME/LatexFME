...
\emph{Camp Solenoidal}
%TODO formula camp solenoidal
\emph{L. Ampère}: $\oint_C \vec{B}\cdot \vec{\dif l} = I_{\text{int}} \mu_0$.
%TODO forma diferencial l. ampere
...
\emph{Càrrega RL}: $I(t) = \frac{\varepsilon_0}{R} \lp 1 - e^{-\frac{Rt}{L}}\rp$.\\
\emph{Energia RL}: $U = \frac{1}{2}LI^2$.

\section{Maxwell}
%TODO equacions de MAXWELL!!
