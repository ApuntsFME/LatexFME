...
\ci $m\vec{a}_{P}^{\, \prime} = \underbrace{m\vec{a}_P}_{\text{f. real}} - [ \underbrace{m\vec{a}_O}_{\text{f. translació}} + \underbrace{2\vec{\omega}\times\vec{v}_{P}^{\, \prime}}_{\text{f. Coriolis}} + \underbrace{\vec{\omega}\times \lp \vec{\omega}\times \vec{r}_{P}^{\, \prime} \rp}_{\text{f. centrípeta}} + \underbrace{\vec{\alpha}\times\vec{r}_{P}^{\, \prime}}_{\text{f. Euler}} ]$.
