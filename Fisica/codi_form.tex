...
\emph{F. camp e.}: $\vec{F} = k\frac{q_1q_2}{\|r|3}\vec{r}=q_2\vec{E}$. \\
\emph{Camp e.}: $\vec{E} = k\frac{q_1}{\|r\|^3}\vec{r}$. \\
\emph{En. pot. e.}: $U = k\frac{q_1q_2}{\|r\|}$. \\
\emph{Pot. e}: $V=-\int_{\infty}^r \|\vec{E}\| \dif r,\, V_{\infty}=0$.
