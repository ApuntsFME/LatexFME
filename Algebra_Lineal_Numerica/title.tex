...
\begin{titlepage} % Suppresses headers and footers on the title page
    ...
    {\LARGE ÁLGEBRA LINEAL NUMÉRICA\\} % Title
   ...
   % {\scshape} % Editor list
    ...
    %{\ifcase \month \or Enero\or Febrero\or Marzo\or Abril\or Mayo \or Junio\or Julio\or Agosto\or Setiembre\or Octubre\or Noviembre\or Diciembre\fi \:  \number \year} %\let\Date\@date
...
\noindent %La elaboración de este documento no habría sido posible sin los apuntes de Oriol Navarro del curso de C\'alculo Integral, impartido por Xavier Gr\`acia en la Facultat de Matemàtiques i Estadísitca de la Universitat Politècnica de Catalunya.
