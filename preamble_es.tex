...
{}%        Punctuation after thm head
{5pt plus 1pt minus 1pt}% Space after thm head: \newline = linebreak
{\index{#3}\thmname{#1}\thmnumber{ #2}.\thmnote{ {\it #3.}}}%         Thm head spec
...
\declaretheorem[style=demos,name=Definición,sibling=lema]{defi}
\declaretheorem[style=demos,name=Definición,numbered=no]{defi*}
