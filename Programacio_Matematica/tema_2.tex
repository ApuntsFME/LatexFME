...
\begin{defi*}[Forma estàndard del dual (provisional)]
...
\begin{equation}\label{eq:partition}
	...
	\end{array}\right]\,,
\end{equation}
on $\varnothing$ indica una submatriu nul·la, $\vb{\rho_\B}$ és un vector d'ordre $m$ que conté totes les variables de $\vb{\rho}$ associades a índexos de la base $\B$, i $\vb{\rho_\N}$ conté la resta (variables de $\vb{\rho}$ associades a un índex de $\N$). Podem reescriure \eqref{eq:partition} com
\begin{equation}
