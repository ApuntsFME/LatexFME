...
\subsection{Solució bàsica factible del poliedre dual}
...
\begin{defi}[partició en variables!bàsiques d'una SBF dual]\idx{partició
    en variables!no bàsiques d'una SBF dual}\label{defi:vd}
...
\begin{alg}[Algorisme del símplex dual]\label{alg:ASD}
	\begin{enumerate}
		\item[]
