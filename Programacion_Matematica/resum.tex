...
\end{prop}
\begin{prop}
    Si $\left(P\right)_e$ no té cap SBFD degenerada, el símplex dual convergeix amb un nombre finit d'iteracions. Altrament, podem usar la regal de Bland per a que convergeixi amb un nombre finit d'iteracions.
\end{prop}
