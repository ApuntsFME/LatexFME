...
\end{prop}
\begin{proof}
    Por ser $H$ un grupo, se tiene que $aH=H=Ha, \,\forall a\in H$. Además, como solamente hay dos clases laterales, se tiene que $aH=G\smallsetminus H=Ha,\,\forall a\in G\smallsetminus H$.
\end{proof}
