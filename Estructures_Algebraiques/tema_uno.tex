...
\begin{proof}
    \begin{enumerate}[i)]
        ...
        \item Sea $f^{-1}\lp x\rp \in f^{-1}\lp K\rp$, donde $x\in K$ y sea $a\in G_1$. Entonces,
            \[
                af^{-1}\lp x\rp a^{-1} = f^{-1}\lp f\lp af^{-1}\lp x\rp a^{-1} \rp \rp = f^{-1}\lp f\lp a\rp xf\lp a\rp ^{-1} \rp \in f^{-1}\lp K\rp,
            \]
            puesto que $f\lp a\rp xf\lp a\rp ^{-1} \in K$.
    \end{enumerate}
\end{proof}
...
\begin{example}
    ...
    \[
        \sigma(12)(34)\sigma^{-1} = \sigma(12)\sigma^{-1}\sigma(34)\sigma^{-1} = (\sigma\lp 1\rp \sigma\lp 2\rp)
