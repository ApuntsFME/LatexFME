...
\end{prop}
\begin{proof}
    Por ser $H$ un subgrupo, se tiene que $aH=H=Ha, \,\forall a\in H$. Además, como solamente hay dos clases laterales, se tiene que $aH=G\setminus H=Ha,\,\forall a\in G\setminus H$.
\end{proof}
