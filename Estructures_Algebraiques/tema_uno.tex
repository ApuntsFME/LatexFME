...
\begin{defi}[acción de un grupo sobre un conjunto]
    ...
    \begin{enumerate}[i)]
        ...
        \item $1x = x$.
    \end{enumerate}
    Diremos que $G$ opera en $X$ o bien que $X$ es un $G$-conjunto.
\end{defi}
...
\begin{obs}
    ...
    Recíprocamente, dada $f \colon G \to \text{Perm}(X)$ morfismo de grupos. Entonces, podemos
    definir una acción
    \[
        \begin{aligned}
...
\begin{obs}
    ...
    = \left\{ ax \mid a \in G \right\} = Gx$ que es la órbita de $x$.

    %TODO wtf diu la frase seguent?
