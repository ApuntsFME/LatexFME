...
\begin{teo}[Segundo teorema de isomorfía]\label{teo:dos_iso}
...
\begin{proof}
    \begin{enumerate}[i)]
        ...
        \item Tenemos $H, P \subseteq N_G(P)$ y $P \triangleleft N_G(P)$, por lo tanto
            ...
            \]
            Por el segundo teorema de isomorfismo (\ref{teo:dos_iso}), $H \cap P \triangleleft H$ y
            podemos aplicar el segundo teorema de isomorfismo,
            \[
