...
\begin{teo}[Teorema de Lagrange]\label{teo_lag}
...
\begin{proof}
    ...
    El punto \ref{prop_q_orb_ite_1} es una consecuencia inmediata del teorema de Lagrange (\ref{teo_lag}) y el punto \ref{prop_q_orb_ite_2} sigue del \ref{prop_q_orb_ite_1}.
