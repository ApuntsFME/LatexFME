...
\begin{example}
    \begin{enumerate}[1.]
        ...
        \item $\lp \Sim_n, \circ \rp$ es el grupo simétrico de $n$ elementos (permutaciones de $n$ elementos).
        \item Grupo diedral. $\lp D_{2n}, \circ \rp$, donde $D_{2n}$ son los conjuntos de las isometrías del plano que dejan invariante $P_n$.
...
\begin{obs}
    ...
    \]
    Y lo denotaremos como $G = C_n$ (grupo cíclico de orden $n$).
