...
\begin{proof}
    ...
    Tenemos ahora que $\langle x^2 \rangle$ es subgrupo propio de $G$. Pero $G$ es abeliano por lo tanto 
    $\langle x^2 \rangle \triangleleft G$ que entra en contradicción con que $G$ es simple. Por tanto, $\orden(x) = n > 1$. 
    ...
    Por lo tanto, $H$ es subgrupo de $G$ y $G$ es abeliano, es decir $H \triangleleft G$, pero $G$ es simple,
    ...
    y como $p$ es primo, $\orden(x) = p$. Ahora se tiene que $\langle x\rangle \subseteq G$, pero los ordenes
...
\begin{proof}
    ...
    \[
        ...
        \end{aligned}
    \]
    y $\tilde{\sigma} \in \Asim_n$. Tomamos $H \triangleleft \Asim_n$  con $H$ no trivial. Entonces $H$ contiene un 3-ciclo. Tomamos 
    ...
    Ahora queremos ver que $H = \Asim_n$. Acabamos de ver que $\exists \sigma \in H$ 3-ciclo y que todo $\tau$ 3-ciclo es el conjugado de $\sigma$
    por un elemento $\rho\in\Asim_n$. Por lo tanto $\tau\in H$ lo que nos dice que $\Asim_n=\langle\text{3-ciclos}\rangle \subseteq H$ y hemos acabado.
\end{proof}
