...
\begin{proof}
    ...
    \langle x^2 \rangle \subset G$. Supogamos que $\orden(x) = \infty$. Entonces, $\langle x^2 \rangle = G \implies x \in \langle x^2\rangle
...
\end{proof}
\begin{col}
    Sea $G$ un grupo tal que $\abs{G} = n\in\n$, con $n$ non. Se tiene que
    \[
...
\begin{proof}
    ...
    \[
        ...
        \end{aligned}
    \]
    y $\tilde{\sigma} \in A_n$. Tomamos $H \triangleleft A_n$,  con $H$ no trivial. Entonces $H$ contiene un 3-ciclo. Tomamos 
    ...
    o bien
    \[
        \exists \tau_1 \tau_2 \in A_n \tq \tau_2 \tau_1\sigma\tau^{-1}\sigma^{-1}\tau_2^{-1}
            \sigma\tau\sigma^{-1}\tau^{-1} \text{ es un 3-ciclo}.
    \]
