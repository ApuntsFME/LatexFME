...
\begin{proof}
    ...
    Si $p \not\vert m$, tenemos que $\langle x\rangle \triangleleft G$ (por ser $G$ abeliano), por lo 
...
\begin{proof}
    \begin{enumerate}[i)]
        \item \fbox{$\implies$} OK. \fbox{$\impliedby$} Suponemos $G$ no trivial. Si $G$ es abeliano $\implies Z(G) = G$
