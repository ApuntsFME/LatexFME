...
\begin{proof}
    ...
    \end{enumerate}
    \noindent Sigui $\varphi\colon K\xhookrightarrow{i} HK \xrightarrow{\pi} \faktor{HK}{H}$. $\faktor{HK}{H}$ es un grupo porque $H\tril HK$. La composición de morfismos de grupos es un morfismo de grupos, de manera que $\varphi$ es un morfismo de grupos. Veamos que $\varphi$ es exhaustiva.
\end{proof}
