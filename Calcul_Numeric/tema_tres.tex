...
Formulación en derivadas: expresamos el Spline en función de $\left\{ f_i \right\}_{i=0}^n$ (conocido) y de las derivadas $\left\{ S'_i \right\}_{i=0}^n$ (no conocido).
\begin{align*}
...
\begin{itemize}
    ...
    \item También podemos imponer $S''\left( x_0 \right) = S''\left( x_n \right) = 0$ para obtener un Spline natural (curvatura inicial y final nula).
        % TODO aqui falta alguna cosa que no entenc
\end{itemize}
