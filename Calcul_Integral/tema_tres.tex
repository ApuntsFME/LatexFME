...
\begin{defi}[camino] \index{curva!parametrizada((tlab))}
...
\begin{defi}[vértices de una poligonal]\index{poligonal de longitud((tlab))}
...
\begin{defi}[camino!rectificable]
...
\begin{defi}[camino!equivalente]\index{composición camino y homeomorfismo((tlab))}
...
\begin{defi}[longitud!de un camino]
...
\begin{defi}[longitud!de una curva regular de clase $\C^1$] \label{defi:observaciones_curvas}
...
\begin{defi}[integral de línea de una función!a lo largo de un camino]
...
\begin{defi}[integral de línea de una función!a lo largo de una curva regular]
...
\begin{defi}[circulación de una función!a lo largo de un camino]
...
\begin{defi}[orientación!de una curva regular]\index{curva!orientada((tlab))}
...
\begin{defi}[circulación de una función!a lo largo de una curva orientada]
...
\begin{defi}[componente!tangencial de una función]
...
\begin{defi}[integral de superficie!(parametrizada) de una funci\'on]
...
\begin{defi}[integral de superficie!(regular) de una función]
...
\begin{defi}[area de una superficie regular]
...
\begin{defi}[integral de superficie!(regular) de un campo vectorial]
...
\begin{defi}[orientación!de una superficie regular]
...
\begin{defi}[superficie!orientada]
...
\begin{defi}[integral de superficie!(orientada) de un campo vectorial]
...
\begin{defi}[vector normal a una superficie]
...
\begin{defi}[componente!normal de un campo vectorial]
...
\section[Integración de funciones en una subvariedad $m$-dimensional de $\real^n$]{
        ...
        \sectionmark{Integración en una subvariedad $m$-dimensional de $\real^n$}}
    \sectionmark{Integración en una subvariedad $m$-dimensional de $\real^n$}
