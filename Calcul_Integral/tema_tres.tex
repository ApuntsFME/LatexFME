...
\begin{defi}[caminos equivalentes]\index{composición de un camino y un homeomorfismo((tlab))}
...
\begin{defi}[orientación de una curva regular parametrizada]\index{curva orientada((tlab))}
...
\begin{defi}[superfície parametrizada regular]
...
\begin{defi}[integral de superfície (parametrizada) de una función]
...
\begin{defi}[integral de superfície (regular) de una función]
