...
\begin{defi}[gradiente]\index{rotacional((tlab))}\index{divergencia((tlab))}
...
\begin{defi}[operador nabla]
    Definimos e operador \emph{nabla} como
    \[
...
\begin{defi}[campo vectorial!conservativo]
    ...
    \]
\end{defi}
\begin{defi}[campo vectorial!solenoidal]
...
\begin{teo}[Teorema fundamental del cálculo, o del gradiente]
...
\begin{teo}[Teorema de Kelvin-Stokes, o del rotacional]\label{teo:kelvin-stokes}
...
\begin{teo}[Teorema de Gauss-Ostrogradski, o de la divergencia]
...
\begin{defi}[subconjunto estrellado]
...
\begin{defi}[gradiente!de un campo escalar]\index{divergencia!de un campo escalar((tlab))}
...
%\section{Operadores diferenciales en otros sistemas de coordenadas}%[Operadores diferenciales en otros s. de coordenadas]
...
\section[Operadores diferenciales en otros sistemas de coordenadas]{
        ...
        \sectionmark{Operadores diferenciales en otros s. de coordenadas}}
    \sectionmark{Operadores diferenciales en otros s. de coordenadas}
