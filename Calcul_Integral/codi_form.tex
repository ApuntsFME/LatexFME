...
% TODO vigilar aqui amb aquesta cutrada
\columnbreak
...
\u{T. Kelvin-Stokes}: (o rotacional) $W \subseteq \real^3$ obert, $\vec{F} \colon W \to \real^3$ classe $\C^1$, $M \subset W$ superficie orientada classe $\C^2 \tq \bar{M}$ compacto, $\bar{M} \subset W$, $\partial M$ amb orientació induïda (m\`a dreta)$^\ast$ $\implies \int_M \rot \vec{F} \dif \vec{S} = \int_{\partial M} \vec{F} \dif \vec{l}$. \\
\u{T. Gauss-Ostrogradski}: (o diverg\`encia) $W \subset \real^3$ obert, $\vec{F} \colon W \to \real^3$ classe $\C^1$, $B \subset W$ obert t.q. $\bar{B}$ compacte, $\bar{B} \subset W$, $\partial B$ amb orientació induïda (m\`a dreta)$^\ast$ $\implies \int_B \diver \vec{F} \dif V = \int_{\partial B} \vec{F} \dif \vec{S}$.
...
\u{T. Green}: $U \subseteq \real^2$ obert, $\vec{F} \colon U \to \real^2$ classe $\C^1$, $M \subset U$ obert t.q. $\bar{M}\subset U$ compacte, $\partial M$ amb orientació induïda (m\`a dreta)$^\ast$ $\implies \int_M ( \pdv{F_2}{x} - \pdv{F_1}{y} ) \dif x \dif y = \int_{\partial M} \vec{F} \dif \vec{l}$.
...
$^\ast$ i punts frontera de $M$ regulars o conjunt de punts frontera singulars \'es finit. \\
\vspace{3pt}
\raggedleft
