...
\iffalse
	...
	\end{obs}
\fi
\begin{teo*}[Teorema de la invariància de l'índex per homotopies]
...
\iffalse
	\begin{teo*}[Teorema de Poincaré-Bohl]
...
\begin{proof}
    ...
    \]
\end{proof}
\begin{teo*}[Teorema de Bolzano (dim 2)]
...
\iffalse
	...
	\begin{teo*}[Teorema de la no retracció]
...
\begin{teo*}[Teorema del punt fix de Brouwer]
