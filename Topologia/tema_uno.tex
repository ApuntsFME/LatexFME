...
\begin{eje}
    ...
    \item
        ...
        \]
        Por consiguiente, $x$ no es un punto interior por la métrica $D_2$ y $\lp a, b \rp \times \real \times \lp c, d \rp \times \real \times \cdots$ no es un conjunto abierto por la métrica $D_2$.
    \end{enumerate}
