...
\begin{proof}
    \begin{enumerate}[i)]
	 ...
	 on $\left\{h_n\right\}$  amb $h_n\geq 0\, \forall n$, és una successió amb límit zeo per la dreta. Aleshores, $\liminf C_n =\limsup C_n = \lc \omega\in\Omega\mid X(\omega)\leq x\rc$.
	 El que ens diu que
	 \[
