...
\begin{prop}
    ...
    \begin{enumerate}[i)]
        ...
        \item $\lim_{x\to-\infty}F_X\lp x\rp = 0$ i $\lim_{x\to\infty}F_X\lp x\rp = 1$.
        \item $F_X$ és contínua per la dreta, és a dir, $\lim_{h\to 0^+}F_X\lp x+h\rp = F_X\lp x\rp$.
    \end{enumerate}
\end{prop}
\begin{proof}
    \begin{enumerate}[i)]
