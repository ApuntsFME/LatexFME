...
\begin{proof}
    \begin{enumerate}[i)]
        ...
        \exists m \colon= m(\omega) \tq \omega\in\bigcap_{k=m(\omega)}^{\infty} A_k \iff
        \omega\in A_r \quad\forall r \ge m(\omega)$
        \item $\omega\in\limsup{A_n} \iff \omege\in\bigcap_{n=1}^{\infty}\bigcup_{k=n}^{\infty} A_k \iff
        \omega\in\bigcup_{k=n}^{\infty}A_k \quad\forall n \iff \forall n,\quad \exists$ %TODO
    \end{enumerate}
\end{proof}
