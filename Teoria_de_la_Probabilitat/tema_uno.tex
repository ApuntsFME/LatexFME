...
\begin{defi}[espai!de probabilitat]\idx{espai!mostral}\index{conjunt!d'esdeveniments((tlab))}\index{conjunt!de successos((tlab))}\index{funció!de probabilitat((tlab))}
