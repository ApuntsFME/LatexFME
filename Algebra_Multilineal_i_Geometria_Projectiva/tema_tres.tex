...
\begin{proof}
    ...
    \begin{itemize}
        ...
        Definimos $H_i := p_0 \vee \dots \vee \hat{p_i} \vee \dots \vee p_n$, $i = 0, \dots, n$ (hiperplano sin $p_i$). Demostremos que $p \not \in H_i \implies f \lp p \rp \notin f \lp H_i \rp$: \\
        $\begin{rcases}
...
\begin{proof}
    \begin{enumerate}[(1)]
        ...
        \begin{gather*}
            ...
            \end{rcases}
            \implies \emptyset \neq r \cap s \stackrel{(*)}{\subseteq} V_1 \cap W \stackrel{\text{supl.}}{=} \emptyset. \text{ Contradicción.}
        \end{gather*}
