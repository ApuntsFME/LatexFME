...
\begin{defi}[proyectividad]
    \begin{enumerate}
        \item[]
        \item Sean $\Po = \Po(\E), \overline{\Po} = \Po\left(\overline{\E}\right)$
        espacios proyectivos de dimensión $n$. Sea $\varphi : \E \to \overline{\E}$
        una aplicación lineal biyectiva. Una proyectividad, definida por $\varphi$, es una aplicación
        \begin{align*}
...
\end{proof}
\begin{defi}[matriz!de una proyectividad]
...
\begin{proof}
    ...
    \begin{enumerate}[(1)]
        ...
        Entonces, $f(p_1) = [\varphi(u_1)], f(p_2) = [\varphi(u_2)], f(p_3) = [\varphi(u_1 + u_2)], f(p_4) = [\varphi(\rho u_1 + u_2)] = [\rho \varphi(u_1) + \varphi(u_2)]$ están alineados, al menos 3 son diferentes y
        \[
            \rho = (f(p_1), f(p_2), f(p_3), f(p_4)).
        \]
    \end{enumerate}
\end{proof}
...
\begin{proof}
    ...
    (de dimensión $n-2$). %SHAME MIQUEL SHAME
    \[
        \begin{rcases}
            \begin{aligned}
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \end{rcases}
        \stackrel{\text{\ref{teo:proy_dim_1}}}{\implies} f$ es una proyectividad (en particular $V = f \lp \Po^1 \rp = L$).
        ...
        \begin{itemize}
            \item Si $p = \overline{p}$ o $p \in \bigcup_{i=0}^n H_i$ ya lo sabemos por \ref{item:1_dela_prop} y \ref{item:2_dela_prop}.
        ...
        \begin{gather*}
            ...
            \stackrel{\ref{item:1_dela_prop} + \ref{item:2_dela_prop}}{=} \lp f \lp p_0 \rp, f \lp p_1 \rp, f \lp \overline{p} \rp, g \lp p \rp \rp \implies f \lp p \rp = g \lp p \rp.
        \end{gather*}
    \end{itemize}
\end{proof}
...
\begin{proof}
    \begin{enumerate}[(1)]
        ...
        \]
    \end{enumerate}
    \noindent Los puntos \ref{item:col_teo2_it1} y \ref{item:col_teo2_it2} implican que $f$ es una colineación. Los puntos \ref{item:col_teo2_it1}, \ref{item:col_teo2_it2} y \ref{item:col_teo2_it3} implican (por el teorema \ref{teo:proyectividades}) que $f$ es una proyectividad
\end{proof}
\begin{teo}[Teorema fundamental de la geometría proyectiva]
    \[ f : \Po^n \to \Po^n \text{ colineación},\, n\geq2 \implies f = [\varphi], \varphi : \E \to \E, \varphi \text{ aplicación semilineal}. \]
...
\end{ej}
\begin{defi}[endomorfismo!semilineal]
...
\begin{defi}[homografía!equivalente]
...
\begin{obs}
    ...
    \end{enumerate}
\end{obs}
\begin{defi}[punto!fijo de una homografía]\index{variedad lineal!de puntos fijos de una homografía((tlab))}
\index{variedad lineal!fija de una homografía((tlab))}
...
\begin{proof}
    \begin{enumerate}[(1)]
        \item[]
        \item Visto.
        \item Por dualidad de \ref{item:1_homografias} y \ref{item:5_homografias}.
        \item $\begin{rcases}
        ...
        \[
            V \subseteq H \iff \overbrace{V^*}^{f\text{-inv. por }\ref{item:5_homografias}} \supseteq \overbrace{H^*}^{f\text{-inv. por }\ref{item:2_homografias}}
        \]
    \end{enumerate}
\end{proof}
...
\begin{obs}
    ...
    \begin{itemize}
        \item Caso 1: $\lambda<0 \rightarrow$ no podemos deducir nada más 
        \item Caso 2: $\lambda = a^2>0 \rightarrow m_\varphi\lp t\rp =
        \begin{cases}
    ...
    \begin{itemize}
        ...
        \begin{gather*}
            \lp q_0, q_1, q, f\lp q\rp\rp = \lp f\lp q_0\rp, f\lp q_1\rp, f\lp q\rp, q\rp = \lp q_0, q_1, f\lp q\rp, q\rp \implies \\
            \implies \lp q_0, q_1, q, f\lp q\rp\rp = -1.
        \end{gather*}
    \end{itemize}
\end{obs}
\begin{example}
...
\begin{defi}[homología]\index{homología!general((tlab))}\index{homología!especial((tlab))}
...
\section{Relación entre afinidades y proyectividades}
    ...
    \end{gather*}
    \begin{defi}[proyectividad!asociada a una afinidad]
...
Sea $g: \Po^n \to \Po^n$ una proyectividad, sea $\overline{A}=M_{\overline{\R}}\lp g\rp$ y supongamos $H$ un hiperplano $g$-invariante. \\
    ...
    \begin{minipage}[c]{0,56\textwidth}
        ...
        \end{gather*}
    \end{minipage}\\
    \begin{defi}[afinidad inducida por una proyectividad]
        ...
        \begin{enumerate}
            ...
            \begin{enumerate}
                \item $H_1$: $x_0=0$\\
                    ...
                    \end{pmatrix}
                    \]
                    que es una translación en $\A^2=\Po^2\setminus H_1$.
                \item $H_2$: $x_2=0$\\
                    ...
                    \[
                        ...
                        H_3\text{: }\tilde{x}_0 = 0
                    \]
                    Y por lo tanto tenemos que $M_{\tilde{\R}}\lp g\rp = M_{\tilde{\R}}\lp g_\text{af} \rp$, lo que nos dice que en $\Po^2\setminus H_3$,
                    \[
                    g_\text{af}\lp x,y\rp = 
                    \begin{pmatrix}
                    0\\
