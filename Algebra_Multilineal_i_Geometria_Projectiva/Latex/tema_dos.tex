...
\begin{axis}[axis equal, hide axis,
		...
		\draw (axis cs:0,0.333) [color=red] -- (axis cs:5,3.666) node[label=250:$(q_3)^*$] {};
...
\[
\begin{aligned}
\text{Cuadrilátero en $\Po^2$} & \qquad \text{Cuadrilátero en $\left( \Po^2 \right)^*$} \\
...
\draw[color=red] (5.255041322314053,6.135537190082645) node {$q_1$};
...
\draw[color=red] (5.13933884297521,3.5404958677685974) node {$q_3$};
...
\draw[color=blue] (6.21,7.36) node {$r_1$};
\draw [fill=blue] (9.14,6.84) circle (2.5pt);
\draw[color=blue] (9.43,6.82) node {$r_4$};
\draw [fill=blue] (9.,5.52) circle (2.5pt);
\draw[color=blue] (9.33,5.36) node {$r_3$};
...
\draw[color=orange] (9.276188556981314,2.63559827552772) node {$r^*$};
\draw [fill=blue] (3.5905034348218994,2.7363496037484754) circle (2.5pt);
\draw[color=blue] (3.4270545812074604,3.069603997094052) node {$(AB)^*$};
\draw [fill=blue] (-0.36,0.52) circle (2.5pt);
\draw[color=blue] (-0.23886970700210086,0.8065741632124634) node {$(AC)^*$};
\draw [fill=blue] (2.236212933445119,0.3958187481586135) circle (2.5pt);
\draw[color=blue] (2.3529621145982897,0.6825725284792257) node {$(BC)^*$};
\draw [fill=blue] (4.564320062604457,2.6690117085413894) circle (2.5pt);
\draw[color=blue] (4.74632032823829,2.961102566702469) node {$(A'B')^*$};
\draw [fill=blue] (4.909911174012507,1.1462661459359629) circle (2.5pt);
\draw[color=blue] (4.594546392739168,1.3645815195120332) node {$(B'C')^*$};
\draw [fill=blue] (5.7636405841417275,1.6921417570208015) circle (2.5pt);
\draw[color=blue] (5.948836894115948,1.9845896931782219) node {$(A'C')^*$};
\draw[color=blue] (2.7966090029803388,1.860588058444984) node {$(B)^*$};
\draw[color=blue] (0.9753217769908749,0.8375745718957729) node {$(C)^*$};
\draw[color=blue] (1.7225165363711676,1.535083767270235) node {$(A)^*$};
\draw[color=blue] (4.617896228969802,1.969089488836567) node {$(B')^*$};
\draw[color=blue] (5.5051900057339,1.3955819281953425) node {$(C')^*$};
\draw[color=blue] (5.330066234004144,2.3410943930362804) node {$(A')^*$};
\draw [fill=gray] (4.278993131711778,3.926220888888763) circle (2.0pt);
\draw[color=gray] (4.489472129701314,3.9531156445683706) node {$(BB')^*$};
\draw [fill=gray] (4.118187037846265,3.032395756792852) circle (2.0pt);
\draw[color=gray] (4.302673439856241,3.3796080839271463) node {$(AA')^*$};
\draw [fill=gray] (3.631836574987902,0.32906371097595916) circle (2.0pt);
\draw[color=gray] (3.415379663092143,0.6360719154542616) node {$(CC')^*$};
\draw[color=red] (7.478251167222485,2.759599910260958) node {$Z^*$};
\draw[color=red] (7.209728050570193,2.2325929626446976) node {$Y^*$};
\draw[color=red] (7.443226412876534,1.597084584636854) node {$X^*$};
\draw[color=purple] (4.115874750011168,2.186092349619733) node {$O^*$};
\end{scriptsize}
\end{tikzpicture}
\end{center}
...
\draw[color=purple] (4.46,5.45) node {$B$};
...
\draw[color=purple] (3.,2.09) node {$A'$};
...
\draw[color=orange] (3.68,3.67) node {$x_0$};
\end{scriptsize}
\end{tikzpicture}
\end{center}
...
\begin{thm}[Cuaterna armónica en el cuadrilátero]
 ...
 \begin{center}
  ...
  \begin{axis}[hide axis,
    ...
    \addplot [color=red,domain=0:7] {-1.08*x+4.38};
    \addplot [color=red,domain=0:7] {0.88*x+1.37};
    \addplot [color=red,domain=0:7] {0.14*x+1.57};
    \addplot [color=red,domain=0:7] {10.9*x-30.7};
    
    \addplot [color=orange,domain=0:7] {2.53*x-3.93};
    \addplot [color=orange,domain=0:7] {-0.49*x+3.48};
    \addplot [color=orange,domain=0:7] {-0.15*x+1.65};
